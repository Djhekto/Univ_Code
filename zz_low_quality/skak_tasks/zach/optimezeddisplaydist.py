...
class MainWindow(QMainWindow):
    def __init__(self,myname):
        ...
        self.r12 = QLabel()
        self.layout.addWidget(self.r12 ,2, 2)
        self.r13 = QLabel()
        self.layout.addWidget(self.r13 ,2, 3)
        self.r14 = QLabel()
        self.layout.addWidget(self.r14 ,2, 4)
        
        self.r21 = QLabel()
        self.layout.addWidget(self.r21 ,3, 1)
        self.r23 = QLabel()
        self.layout.addWidget(self.r23 ,3, 3)
        self.r24 = QLabel()
        self.layout.addWidget(self.r24 ,3, 4)

        self.r31 = QLabel()
        self.layout.addWidget(self.r31 ,4, 1)
        self.r32 = QLabel()
        self.layout.addWidget(self.r32 ,4, 2)
        self.r34 = QLabel()
        self.layout.addWidget(self.r34 ,4, 4)       

        self.r41 = QLabel()
        self.layout.addWidget(self.r41 ,5, 1)
        self.r42 = QLabel()
        self.layout.addWidget(self.r42 ,5, 2)
        self.r43 = QLabel()
        self.layout.addWidget(self.r43 ,5, 3)   
        ...
        for j in range(1,5):
                ...
                if j==1:
                    print("обучающая матрица 1 :",matrix1)
                if j==3:
                    print("обучающая матрица 3 :",matrix1)
    ...
    def main_calculation(self):
        ...
        for delta in range(50,51,5):
            ...
            print("бинарная матрица 1", self.matrixbin1)
            ...
            print("бинарная матрица 3", self.matrixbin3)
                ...
                for ro_2 in range(55,56,10):
                    ...
                    for ro_3 in range(40,41,10):
                        ...
                        for ro_4 in range(35,36,10):
                            ...
                            self.rasstoyanie14 = 0
                            for i,e in enumerate(self.SK1_short[0]):
                                if e != self.SK1_short[3][i]:
                                    self.rasstoyanie14 += 1
                            ...
                            self.rasstoyanie24 = 0
                            for i,e in enumerate(self.SK2_short[1]):
                                if e != self.SK2_short[3][i]:
                                    self.rasstoyanie24 += 1
                            ...
                            self.rasstoyanie42 = 0
                            for i,e in enumerate(self.SK4_short[3]):
                                if e != self.SK4_short[1][i]:
                                    self.rasstoyanie42 += 1
                            self.rasstoyanie43 = 0
                            for i,e in enumerate(self.SK4_short[3]):
                                if e != self.SK4_short[2][i]:
                                    self.rasstoyanie43 += 1
                            
                            print(self.rasstoyanie12,self.rasstoyanie13,self.rasstoyanie14)
                            print(self.rasstoyanie21,self.rasstoyanie23,self.rasstoyanie24)
                            print(self.rasstoyanie31,self.rasstoyanie32,self.rasstoyanie34)
                            print(self.rasstoyanie41,self.rasstoyanie42,self.rasstoyanie43)
                            
                            self.r12.setText(str(self.rasstoyanie12))
                            self.r13.setText(str(self.rasstoyanie13))
                            self.r14.setText(str(self.rasstoyanie14))

                            self.r21.setText(str(self.rasstoyanie21))
                            self.r23.setText(str(self.rasstoyanie23))
                            self.r24.setText(str(self.rasstoyanie24))                            

                            self.r31.setText(str(self.rasstoyanie31))
                            self.r32.setText(str(self.rasstoyanie32))
                            self.r34.setText(str(self.rasstoyanie34))    

                            self.r41.setText(str(self.rasstoyanie41))
                            self.r42.setText(str(self.rasstoyanie42))
                            self.r43.setText(str(self.rasstoyanie43))    
        ...
        #ax1.plot(BESTKFE12_Kulbak,label=f'Для delta = {delta} ro_1 = {ro1}')
        ...
        fig1, ax1 = plt.subplots()
        #ax1.plot(BESTKFE23_Kulbak,label=f'Для delta = {delta} ro_2 = {ro2}')
        ...
        fig1, ax1 = plt.subplots()
        #ax1.plot(BESTKFE34_Kulbak,label=f'Для delta = {delta} ro_3 = {ro3}')
        ...
        fig1, ax1 = plt.subplots()
        #ax1.plot(BESTKFE41_Kulbak,label=f'Для delta = {delta} ro_4 = {ro4}')
