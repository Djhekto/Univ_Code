...
#----------------------------------------------------------
    ...
    def switch_functions(self):
        ...
        for delta in range(50,51,10):
            for ro_1 in range(50,51,10):
                nro_1 = ro_1/100
                for ro_2 in range(50,51,10):
                    nro_2 = ro_2/100
                    for ro_3 in range(50,51,10):
                        nro_3 = ro_3/100
        ...
        ro2=sbestro2/100
        ro3=sbestro3/100
        print(f" значение дельта = {delta}\n")
        print(f" значение 1 радиуса {ro1}\n")
        print(f" значение 2 радиуса {ro2}\n")
        print(f" значение 3 радиуса {ro3}\n")
        print(f" значение суммы кфе Шеннона KFE {bestkfe}\n")
