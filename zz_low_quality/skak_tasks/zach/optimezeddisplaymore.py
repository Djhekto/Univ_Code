...
class MainWindow(QMainWindow):
    def __init__(self,myname):
        ...
        self.txt_out1ev = QLabel()
        self.layout.addWidget(self.txt_out1ev,4, 1)
        self.txt_out2ev = QLabel()
        self.layout.addWidget(self.txt_out2ev,4, 2)
        self.txt_out3ev = QLabel()
        self.layout.addWidget(self.txt_out3ev,4, 3)
        self.txt_out4ev = QLabel()
        self.layout.addWidget(self.txt_out4ev,4, 4)
    ...
    def main_calculation(self):
        ...
        #self.txt_out1ev.setText(str(self.bestev1))
        self.txt_out1ev.setText(f"EV1\n {self.bestev1[0:20]}\n{self.bestev1[20:40]}\n{self.bestev1[60:80]}\n{self.bestev1[80:90]}\n")
        self.txt_out2ev.setText(f"EV2\n {self.bestev2[0:20]}\n{self.bestev2[20:40]}\n{self.bestev2[60:80]}\n{self.bestev2[80:90]}\n")
        self.txt_out3ev.setText(f"EV3\n {self.bestev3[0:20]}\n{self.bestev3[20:40]}\n{self.bestev3[60:80]}\n{self.bestev3[80:90]}\n")
        self.txt_out4ev.setText(f"EV4\n {self.bestev4[0:20]}\n{self.bestev4[20:40]}\n{self.bestev4[60:80]}\n{self.bestev4[80:90]}\n")
        ...
        for t in range(trials):
            ...
            if t%10==0: print()
            if t%10==0: print("==========================")
        print(f"Из {trials} запусков было успешно предсказано {correct}.")
