...
class MainWindow(QMainWindow):
    def __init__(self,myname):
        ...
        self.myname = myname
        self.IMAGESIZE = 90
        self.setWindowTitle("ВЫПОЛНЕНИЕ ЗАДАЧИ БЕЗ ОПТИМИЗАЦИИ ПАРАМЕТРОВ")
    ...
    def main_calculation(self):
        ...
        for delta in range(20,100,100):
            for ro_1 in range(50,100,100):
                nro_1 = ro_1/100
                for ro_2 in range(20,100,100):
                    nro_2 = ro_2/100
                    for ro_3 in range(40,100,100):
                        nro_3 = ro_3/100
                        ro_4 = 50
                        nro_4 = ro_4/100
#------------------------------                                        
...
#------------------------------
        ...
        plt.ylim(0, 1)
        plt.legend()
        plt.title("KFE34 ДО ОПТИМИЗАЦИИ")
        ...
        plt.ylim(0, 1)
        plt.legend()
        plt.title("KFE41 ДО ОПТИМИЗАЦИИ")
